...
{ 
    public class DirectDrawSurfaceStream : MemoryStream
    {
        ...
        public byte[] bData1
        {
            get { Reader.BaseStream.Position = dataOffset; return Reader.ReadBytes(bData1_Length); }
            set
            {
        ...
        private int dataOffset = 128;

        public int bdata2_Length;

        public byte[] bData2
        {
            get { Reader.BaseStream.Position = dataOffset + bData1_Length; return Reader.ReadBytes((int)(Reader.BaseStream.Length - Reader.BaseStream.Position)); }
            set
            {
                Writer.BaseStream.Position = dataOffset + bData1_Length;
        ...
        static Dictionary<H2BitmapCollection.BitmapData.EFormat, DDPIXELFORMAT> Lookup;

        static DirectDrawSurfaceStream()
        {
            ...
            Format.BitsPerPixel = 8;
            Format.AlphaBitMask = 0x000000FF;
            Lookup.Add(H2BitmapCollection.BitmapData.EFormat.AL8, Format);
            Format = DDPIXELFORMAT.CreateInstance();
            Format.LuminanceBitMask = 0x000000FF;
            Format.BitsPerPixel = 8;
            Lookup.Add(H2BitmapCollection.BitmapData.EFormat.L8, Format);
            Format = DDPIXELFORMAT.CreateInstance();
            Format.LuminanceBitMask = 0x000000FF;
            Format.BitsPerPixel = 8;
            ...
            Format.LuminanceBitMask = 0x000000FF;
            Lookup.Add(H2BitmapCollection.BitmapData.EFormat.A8L8, Format);
            Format = DDPIXELFORMAT.CreateInstance();
            Format.BitsPerPixel = 16;
            ...
            Lookup.Add(H2BitmapCollection.BitmapData.EFormat.ARGB4444, Format);
            Format = DDPIXELFORMAT.CreateInstance();
            Format.BitsPerPixel = 16;
            ...
            Lookup.Add(H2BitmapCollection.BitmapData.EFormat.ARGB1555, Format);
            Format = DDPIXELFORMAT.CreateInstance();
            Format.BitsPerPixel = 16;
            ...
            Lookup.Add(H2BitmapCollection.BitmapData.EFormat.ARGB8888, Format);
            Format = DDPIXELFORMAT.CreateInstance();
            Format.BitsPerPixel = 32;
            Format.RedBitMask = 0x00FF0000;
            Format.GreenBitMask = 0x0000FF00;
            Format.BlueBitMask = 0x000000FF;
            Lookup.Add(H2BitmapCollection.BitmapData.EFormat.XRGB8888, Format);
        }
        ...
        public void ImportTexture(H2BitmapCollection.BitmapData Meta, byte[] Raw)
        {
            SurfaceDescription = new DDSURFACEDESC2Stream(this);
            ...
            else if (Meta.Format == H2BitmapCollection.BitmapData.EFormat.DXT3 ||
                     Meta.Format == H2BitmapCollection.BitmapData.EFormat.DXT5)
            {
                SurfaceDescription.dwFlags |= DDSURFACEDESC2Stream.EdwFlags.DDSD_LINEARSIZE;
            ...
            else if ((SurfaceDescription.PixelFormat.dwFlags & DDSURFACEDESC2Stream.DDPIXELFORMAT.EdwFlags.DDPF_YUV) == DDSURFACEDESC2Stream.DDPIXELFORMAT.EdwFlags.DDPF_YUV)
            {
            ...
            if (Meta.Type == H2BitmapCollection.EType.CUBEMAPS)
            {
                SurfaceDescription.Capibilties.dwCaps2 = 
                    DDSURFACEDESC2Stream.DDCAPS.EdwCaps2.DDSCAPS2_CUBEMAP |
                    DDSURFACEDESC2Stream.DDCAPS.EdwCaps2.DDSCAPS2_CUBEMAP_NEGATIVEX |
                    DDSURFACEDESC2Stream.DDCAPS.EdwCaps2.DDSCAPS2_CUBEMAP_NEGATIVEY |
                    DDSURFACEDESC2Stream.DDCAPS.EdwCaps2.DDSCAPS2_CUBEMAP_NEGATIVEZ |
                    DDSURFACEDESC2Stream.DDCAPS.EdwCaps2.DDSCAPS2_CUBEMAP_POSITIVEX |
                    DDSURFACEDESC2Stream.DDCAPS.EdwCaps2.DDSCAPS2_CUBEMAP_POSITIVEY |
                    DDSURFACEDESC2Stream.DDCAPS.EdwCaps2.DDSCAPS2_CUBEMAP_POSITIVEZ;
            }
            ...
            {
                bData1 = Reader.ReadBytes(SurfaceDescription.dwPitchOrLinearSize * SurfaceDescription.dwHeight);
            }
        ...
        public H2BitmapCollection.BitmapData.EFormat GetFormat()
        {
